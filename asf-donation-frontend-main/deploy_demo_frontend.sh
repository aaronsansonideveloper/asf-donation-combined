...
# Variables
LOCAL_DIR="/home/asp/Documents/codeRepo/scaling-project/scaling-frontend/packages/newNext"  # Replace with the path to your local project folder
TARGET_SERVER="root@67.219.110.43"
# KEY_FILE="/home/avarile/Documents/Depolyment/AWSTest/ScalingTest/ScalingTesServerKey.pem"
KEY_FILE="/home/asp/Documents/Deployments/AWSTest/ScalingTest/ScalingTesServerKey.pem"
REMOTE_DIR="/root/project/scaling-frontend/packages/newNext"
VERSION="0.0.8"
COMMIT_CONTENT="feat: deploy demo"
...
ssh -i "$KEY_FILE" "$TARGET_SERVER" && "cd $REMOTE_DIR" && "pm2 restart 0"

# to run this script, use the following command:
# export VERSION=0.0.1 COMMIT_CONTENT=testing:statistics && bash ./deploy_demo.sh 