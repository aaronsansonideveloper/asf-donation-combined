...
export const paths = {
  ...
  account: {
    ...
    postDeal: `/postDealStep/#step=1`,
    postDealStep: `/postDealStep`,
  ...
  about: '/about',
  // hubspot suport
  hubspot: 'https://share.hsforms.com/1JUpP1_XlQYGXmopT9wSdJwqznu7',
  // FAQs
  faqs: {
    root: '/faqs',
    generalQuestions: '/faqs/general-questions',
    privatePolicy: '/faqs/private-policy',
  },
  howto: {
    root: '/howto',
    deal: '/howto/deal',
