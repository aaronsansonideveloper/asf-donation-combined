...
import { Iconify, UploadProps, useBoolean } from 'src/muiEazy';
...
export function UploadAvatar({
  ...
  const imgUrl = typeof fileNameList?.[0] === 'string' ? fileNameList?.[0] : '';
  ...
  return (
    ...
    >
      ...
      >
        {imgUrl && <Avatar src={imgUrl} sx={{ width: 90, height: 90 }} />}
        {!imgUrl && (
          <Box
            sx={{
              p: 1,
